    ...
    TaskyBackground(
        ...
        header = {
            DetailHeader(
                ...
                date = state.date,
                onClose = { onEvent(TaskDetailEvent.OnClose) },
                onEdit = { onEvent(TaskDetailEvent.OnEdit) },
                onSave = { onEvent(TaskDetailEvent.OnSave) },)
        }
    ) {
        Column(
            ...
            Box {
                ...
                Box(
                    ...
                    Text(
                        modifier = Modifier.clickable { onEvent(TaskDetailEvent.OnTaskDelete) },
